...
@threestudio.register("mvdream-inpaint-multiview-diffusion-guidance")
class MultiviewInpaintDiffusionGuidance(BaseObject):
    @dataclass
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # 1. 3 tiles: gt_rgb vs rendered rgb
        # 2. 1 tile: MVDiffusion recon loss vs rendered rgb
        # Implement such loss
